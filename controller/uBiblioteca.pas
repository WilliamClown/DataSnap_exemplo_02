...
uses
  ...
  IdHashMessageDigest, uConstantes, Math, Rtti, TypInfo,
  uAtributos,
  StrUtils;
...
begin
  ...
  if Tipo = 'Q' then
  begin
    for i := 1 to uConstantes.TConstantes.DECIMAIS_QUANTIDADE do
      Mascara := Mascara + '0';
  end
  else if Tipo = 'V' then
  begin
    for i := 1 to uConstantes.TConstantes.DECIMAIS_VALOR do
      Mascara := Mascara + '0';
  end;
